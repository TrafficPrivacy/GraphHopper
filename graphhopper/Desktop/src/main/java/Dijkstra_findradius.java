 ...
 * @author Peter Karich
 */
public class Dijkstra_findradius extends AbstractRoutingAlgorithm {
    ...
    public Dijkstra_findradius(Graph graph, FlagEncoder encoder, Weighting weighting, TraversalMode tMode) {
    ...
    protected boolean allRadiiExceed() {
        return currEdge.adjNode == to;
    }
